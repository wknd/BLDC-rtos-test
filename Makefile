...
CPPSRC =	$(CHCPPSRC) \
			main.cpp \
			library/src/tester.cpp \
			library/src/ThreePhaseDriver.cpp \
			library/src/ADC.cpp \
			library/src/currentControl.cpp \
			library/src/Commands.cpp \
			library/src/Controller.cpp \
			library/src/PositionSense.cpp
...
INCDIR = $(CHIBIOS)/os/license \
         ...
         $(CHCPPINC) $(CHIBIOS)/os/various $(STREAMSINC) \
         $(CMSIS)/Include
